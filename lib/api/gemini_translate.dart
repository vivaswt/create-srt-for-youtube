...
Future<List<String>> translateSrt(Iterable<String> srts, String apiKey) =>
...
const String _translateSystemInstruction = '''
  ...
  6. Your response should only consist of SRT records and should exclude other elements, such as comments, analysis or co
''';
